              ...
              <FadeContent delay={0.6}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" className="px-8 py-3 text-lg font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-md">
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button variant="outline" size="lg" className="px-8 py-3 text-lg font-semibold border-2 border-gray-400 text-gray-200 hover:bg-gray-700 hover:text-white rounded-md">
